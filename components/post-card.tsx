...
export default function PostCard({
  ...
  return (
    <div className="relative rounded-lg border border-stone-500 bg-stone-100 pb-10  transition-all hover:shadow-xl dark:border-stone-700 dark:hover:border-white">
      <Link
        href={`/post/${data.id}`}
